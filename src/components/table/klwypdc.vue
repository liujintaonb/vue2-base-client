...
<template>
  <div class="c-table">
    <table border="1" rules="all" border-collapse="collapse" width="100%">
      <!--            1-->
      <tr>
        <td class="info-title">枯落物样品编号</td>
        <td class="info-title">枯落物样品鲜重(g)</td>
        <td class="info-title">枯落物样品干重(g)</td>
        <td class="info-title">枯落物样品干鲜比(%)</td>
        <td class="info-title">枯落物样品含水率(%)</td>
      </tr>
